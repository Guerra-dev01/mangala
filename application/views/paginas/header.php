...
<body class="fix-header fix-sidebar card-no-border">
        <?php 
           ...
           // $basicinfo = $this->employee_model->GetBasic($id); 
            $userinfo = $this->employee_model->GetUserInfo($id);
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/mangala/logo3.png" alt="Mangala" class="dark-logo" style="width:50px; background-color:#67757c;"/>
                        </b>
                        <!-- Logo text -->
                        <span>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu mailbox scale-up-left">
                        <ul>
                            ...
                            <li>
                                <a class="nav-link text-center" href="javascript:void(0);"> <strong>Ver todas as notifica&ccedil;&otilde;es</strong> <i class="fa fa-angle-right"></i> </a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    ...
                                    <div class="u-text">
                                        <h4><?php echo $userinfo->nome; //$basicinfo->first_name.' '.$basicinfo->last_name; ?></h4>
                                        <p class="text-muted"><?php echo $userinfo->email;//$basicinfo->em_email ?></p>
                                </div>
                            </li>

                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($userinfo->codUtil); ?>"><i class="ti-user"></i> Meu Perfil</a></li>
                            <?php if($this->session->userdata('codPerfil')!='3') /*user_type*; EMPLOYEE*/{ ?>
                                    
                            <li><a href="#<?php echo base_url(); ?>settings/Settings"><i class="ti-settings"></i> Defini&ccedil;&atilde;o de conta</a></li> <!--settings/Settings-->
                            <?php } ?>
