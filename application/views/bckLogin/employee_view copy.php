<?php $this->load->view('paginas/header'); ?>
<?php $this->load->view('paginas/sidebar'); ?>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab" style="font-size: 14px;"> Dados Pessoais <!--Personal Info--> </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab" style="font-size: 14px;"> Endere&ccedil;o <!--Address--> </a> </li>
                                ...
                                <?php } else { ?>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#password1" role="tab" style="font-size: 14px;"> Alterar senha</a> </li>                                
                                <?php } ?>
                            </ul>
                            <!-- Tab panes -->
...
<?php $this->load->view('paginas/footer'); ?>