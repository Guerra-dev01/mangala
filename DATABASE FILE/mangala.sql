...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Out-2022 às 11:11
...
--
-- Banco de dados: `mangala`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `addition`
--
...
--
-- Extraindo dados da tabela `addition`
--
...
--
-- Estrutura da tabela `assets_category`
--
...
--
-- Extraindo dados da tabela `assets_category`
--
...
--
-- Estrutura da tabela `assign_leave`
--
...
--
-- Extraindo dados da tabela `assign_leave`
--
...
--
-- Estrutura da tabela `assign_task`
--
...
--
-- Extraindo dados da tabela `assign_task`
--
...
--
-- Extraindo dados da tabela `bank_info`
--
...
--
-- Estrutura da tabela `desciplinary`
--
...
--
-- Extraindo dados da tabela `desciplinary`
--
...
--
-- Extraindo dados da tabela `designation`
--
...
--
-- Estrutura da tabela `earned_leave`
--
...
--
-- Extraindo dados da tabela `earned_leave`
--
...
CREATE TABLE `employee` (
  ...
  `status` enum('ACTIVO(A)','INACTIVO(A)') NOT NULL DEFAULT 'ACTIVO(A)',
...
INSERT INTO `employee` (`id`, `em_id`, `em_code`, `des_id`, `dep_id`, `nome`, `first_name`, `last_name`, `em_email`, `em_password`, `em_role`, `provincia`, `status`, `em_gender`, `em_phone`, `em_birthday`, `em_blood_group`, `em_joining_date`, `em_contact_end`, `em_image`, `em_nid`, `perfil`, `username`, `email`, `senha`, `data_cadastro`) VALUES
(10, 'Soy1332', '99', 0, 2, '', 'Thom', 'Anderson', 'thoma@mail.com', '25c2c9afdd83b8d34234aa2881cc341C09689aaa', 'SUPER ADMIN', '', 'ACTIVO(A)', 'Female', '7856587870', '1985-12-05', 'O-', '2022-10-06', '2018-01-06', 'userav-min.png', '132154566556', '', '', '', '', NULL),
(36, 'Doe1753', '123456', 12, 2, '', 'Will', 'Williams', 'admin@mail.com', 'cd5ea73cd58f827fa78eef7197b8ee606c99b2e6', 'ADMIN', '', 'ACTIVO(A)', 'Male', '999999900', '1990-12-13', 'O+', '2019-02-15', '2019-02-22', 'user.png', '01253568955555', '', '', '', '', NULL),
(37, 'Doe1754', '123444', 12, 2, '', 'John', 'Greenwood', 'employee@mail.com', 'cd5ea73cd58f827fa78eef7197b8ee606c99b2e6', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', '1111110010', '1995-10-30', 'O+', '2019-02-15', '2019-02-22', 'Doe1753.jpg', '01253568955555', '', '', '', '', NULL),
(38, 'Moo1402', '6969', 13, 5, '', 'Liam', 'Moore', 'liam@mail.com', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', '7124589965', '1994-03-23', 'A-', '2021-05-04', '2023-05-17', 'Moo1402.png', '1234567890', '', '', '', '', NULL),
(39, 'Rob1472', '1058', 9, 4, '', 'Stephany', 'Robs', 'stephany@mail.com', '7672fb4033bc7bc14e2e26e5e0679e3c2a1bd514', 'EMPLOYEE', '', 'ACTIVO(A)', 'Female', '7850001111', '1992-12-24', 'A+', '2021-04-14', '', 'Rob1472.png', '7000105000', '', '', '', '', NULL),
(40, 'Tho1044', '8877', 13, 5, '', 'Chris', 'Thompson', 'chris@mail.com', '260a678229cde1991cd1ac0d6adb4980c76c5e7f', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', '7852140000', '1993-01-02', 'AB+', '2021-10-01', '', 'Tho1044.png', '0102580010', '', '', '', '', NULL),
(41, 'Smi1266', '3008', 23, 8, '', 'Colin', 'Smith', 'colin@mail.com', '7b4286b09972e2859b718440aa68a2a6eeb869dd', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', '7400001450', '1990-12-12', 'B+', '2021-10-10', '', 'Smi1266.png', '0147000000', '', '', '', '', NULL),
(42, 'Moo1634', '6661', 26, 10, '', 'Christine', 'Moore', 'christine@mail.com', '37219392e904e98b6dca4f729f1d29c642d40e19', 'EMPLOYEE', '', 'ACTIVO(A)', 'Female', '1010140000', '1991-04-05', 'A-', '2021-10-10', '', 'Moo1634.png', '147850000144', '', '', '', '', NULL),
(43, 'Joh1474', '8829', 22, 7, '', 'Michael', 'Johnson', 'michael@mail.com', 'd492ed1b1fdfbc9ca9db7c10c7df38d2b488fb14', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', '7801450000', '1986-02-23', 'B-', '2021-02-02', '', 'Joh1474.png', '600254000014', '', '', '', '', NULL),
(44, 'Den1745', '6600', 20, 7, '', 'Emily', 'Denn', 'emily@mail.com', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'EMPLOYEE', '', 'ACTIVO(A)', 'Female', '7410144470', '1996-03-03', 'AB+', '2021-10-10', '', 'Den1745.png', '880024520000', '', '', '', '', NULL),
(51, NULL, NULL, NULL, NULL, 'Aurelio Guerra', NULL, NULL, 'anaguerra@gmail.com', '$2y$10$/OJs4WPnuX7W8oF3HZc6PehHbwNw1hm8YLhVd218DygEaAMQxCFvu', 'EMPLOYEE', '', 'ACTIVO(A)', 'Male', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Denunciante', 'azguerra', 'anaguerra@gmail.com', '$2y$10$HjplNfNTF.tK7ZcgGLeT0O47Wx9xkHskMqaHO4I4I.mvRjkvi35rS', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `employee_file`
--
...
--
-- Estrutura da tabela `emp_assets`
--
...
--
-- Estrutura da tabela `emp_experience`
--
...
--
-- Extraindo dados da tabela `emp_leave`
--
...
--
-- Estrutura da tabela `emp_penalty`
--
...
--
-- Estrutura da tabela `emp_salary`
--
...
--
-- Extraindo dados da tabela `emp_salary`
--
...
--
-- Estrutura da tabela `emp_training`
--
...
--
-- Estrutura da tabela `field_visit`
--
...
--
-- Extraindo dados da tabela `holiday`
--
...
--
-- Extraindo dados da tabela `leave_types`
--
...
--
-- Estrutura da tabela `loan_installment`
--
...
--
-- Extraindo dados da tabela `loan_installment`
--
...
--
-- Estrutura da tabela `logistic_asset`
--
...
--
-- Extraindo dados da tabela `logistic_asset`
--
...
--
-- Estrutura da tabela `logistic_assign`
--
...
--
-- Estrutura da tabela `pay_salary`
--
...
--
-- Extraindo dados da tabela `pay_salary`
--
...
--
-- Estrutura da tabela `project_file`
--
...
--
-- Estrutura da tabela `pro_expenses`
--
...
--
-- Extraindo dados da tabela `pro_task`
--
...
--
-- Estrutura da tabela `pro_task_assets`
--
...
--
-- Extraindo dados da tabela `salary_type`
--
...
(1, 'hrtag.png', 'mangala', 'Just a demo description and nothing else!', 'Oasis IT', '0001110000', 'MZN', 'MZN', 'mangala@restart.co.mz', '102 Blue St', '1102 Blecker St');
...
--
-- Estrutura da tabela `tbanexo`
--

CREATE TABLE `tbanexo` (
  `codAnexo` int(11) NOT NULL,
...
--
-- Estrutura da tabela `tbcategoriadenunciante`
--

CREATE TABLE `tbcategoriadenunciante` (
  `codCatDenuncte` int(11) NOT NULL,
  `tipo` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tbcategoriadenunciante`
--

INSERT INTO `tbcategoriadenunciante` (`codCatDenuncte`, `tipo`) VALUES
(1, 'Anonimo'),
(2, 'Terceiro'),
(3, 'Normal');
...
--
-- Estrutura da tabela `tbdadosempresa`
--
...
CREATE TABLE `tbdadosempresa` (
  ...
  `email_envio` varchar(250) NOT NULL,
...
CREATE TABLE `tbdenuncia` (
  ...
  `codTipoDenuncia` int(11) NOT NULL,
  `nome` varchar(80) NOT NULL,
  `email` varchar(40) NOT NULL,
...
--
-- Estrutura da tabela `tbdistrito`
--
...
--
-- Extraindo dados da tabela `tbdistrito`
--

INSERT INTO `tbdistrito` (`codDistrito`, `nome`, `codProvincia`) VALUES
(1, 'Govuru', 12),
(2, 'Inharrime', 12);
...
INSERT INTO `tbperfil` (`codPerfil`, `nome`) VALUES
(1, 'Administrador'),
(2, 'Gestor'),
(5, 'Denunciante');
...
CREATE TABLE `tbprovincia` (
  `codProvincia` int(11) NOT NULL,
  `nome_prov` varchar(250) NOT NULL,
...
INSERT INTO `tbprovincia` (`codProvincia`, `nome_prov`, `email`) VALUES
(1, 'Maputo', 'isacseguiwa@oasisit.com'),
(2, 'Gaza', 'aurelioguerra@oasisit.com'),
(12, 'Inhambane', 'helenachirindza@oasisit.com');
...
INSERT INTO `tbtipodenuncia` (`codTipoDenuncia`, `tipo`) VALUES
(1, 'Assedio'),
(2, 'Agressao fisica'),
(3, 'Ameaca');
...
--
-- Estrutura da tabela `to-do_list`
--
...
--
-- Extraindo dados da tabela `to-do_list`
--
...
INSERT INTO `users1` (`id`, `name`, `email`, `password`, `role_id`) VALUES
...
(5, 'Admin', 'admin@mail.com', '$2y$10$I40HXIfVaDxe0LzdigrCReAGnnSO9Gwe8AywDYj086skZlftVXBwK', 1);
...
--
-- Índices para tabela `assets_category`
--
ALTER TABLE `assets_category`
  ADD PRIMARY KEY (`cat_id`);

--
-- Índices para tabela `assign_leave`
--
ALTER TABLE `assign_leave`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `assign_task`
--
...
--
-- Índices para tabela `bank_info`
--
ALTER TABLE `bank_info`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `deduction`
--
...
--
-- Índices para tabela `desciplinary`
--
...
--
-- Índices para tabela `earned_leave`
--
...
ALTER TABLE `employee`
  ADD PRIMARY KEY (`id`),
  ADD KEY `codProvincia` (`provincia`);

--
-- Índices para tabela `employee_file`
--
ALTER TABLE `employee_file`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `emp_assets`
--
ALTER TABLE `emp_assets`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `emp_experience`
--
ALTER TABLE `emp_experience`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `emp_leave`
--
ALTER TABLE `emp_leave`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `emp_penalty`
--
ALTER TABLE `emp_penalty`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `emp_salary`
--
ALTER TABLE `emp_salary`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `field_visit`
--
ALTER TABLE `field_visit`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `holiday`
--
ALTER TABLE `holiday`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `leave_types`
--
...
--
-- Índices para tabela `loan_installment`
--
ALTER TABLE `loan_installment`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `logistic_asset`
--
ALTER TABLE `logistic_asset`
  ADD PRIMARY KEY (`log_id`);

--
-- Índices para tabela `logistic_assign`
--
...
--
-- Índices para tabela `pay_salary`
--
...
--
-- Índices para tabela `project_file`
--
ALTER TABLE `project_file`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `pro_expenses`
--
ALTER TABLE `pro_expenses`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `pro_notes`
--
ALTER TABLE `pro_notes`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `pro_task`
--
ALTER TABLE `pro_task`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `pro_task_assets`
--
...
--
-- Índices para tabela `tbanexo`
--
ALTER TABLE `tbanexo`
  ADD PRIMARY KEY (`codAnexo`),
  ADD KEY `codDenuncia` (`codDenuncia`);

--
-- Índices para tabela `tbcategoriadenunciante`
--
ALTER TABLE `tbcategoriadenunciante`
  ADD PRIMARY KEY (`codCatDenuncte`);

--
-- Índices para tabela `tbdadosempresa`
--
...
ALTER TABLE `tbdenuncia`
  ...
  ADD KEY `codCatDenuncte` (`codCatDenuncte`),
  ADD KEY `codTipoDenuncia` (`codTipoDenuncia`),
  ADD KEY `codUtil` (`codUtil`),
  ADD KEY `codAnexo` (`codAnexo`);

--
-- Índices para tabela `tbdistrito`
--
...
--
-- Índices para tabela `tbprovincia`
--
...
ALTER TABLE `tbtipodenuncia`
  ADD PRIMARY KEY (`codTipoDenuncia`);

--
-- Índices para tabela `tbutilizador`
--
...
--
-- Índices para tabela `to-do_list`
--
ALTER TABLE `to-do_list`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `users1`
--
ALTER TABLE `users1`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `addition`
--
ALTER TABLE `addition`
...
--
-- AUTO_INCREMENT de tabela `assets_category`
--
ALTER TABLE `assets_category`
  MODIFY `cat_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `assign_leave`
--
ALTER TABLE `assign_leave`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `assign_task`
--
ALTER TABLE `assign_task`
...
--
-- AUTO_INCREMENT de tabela `bank_info`
--
ALTER TABLE `bank_info`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de tabela `deduction`
--
ALTER TABLE `deduction`
...
--
-- AUTO_INCREMENT de tabela `desciplinary`
--
ALTER TABLE `desciplinary`
...
--
-- AUTO_INCREMENT de tabela `earned_leave`
--
ALTER TABLE `earned_leave`
...
--
-- AUTO_INCREMENT de tabela `employee_file`
--
ALTER TABLE `employee_file`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `emp_assets`
--
ALTER TABLE `emp_assets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `emp_experience`
--
ALTER TABLE `emp_experience`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `emp_leave`
--
ALTER TABLE `emp_leave`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `emp_penalty`
--
ALTER TABLE `emp_penalty`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `emp_salary`
--
ALTER TABLE `emp_salary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de tabela `field_visit`
--
ALTER TABLE `field_visit`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `holiday`
--
ALTER TABLE `holiday`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `leave_types`
--
ALTER TABLE `leave_types`
...
--
-- AUTO_INCREMENT de tabela `loan_installment`
--
ALTER TABLE `loan_installment`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT de tabela `logistic_asset`
--
ALTER TABLE `logistic_asset`
  MODIFY `log_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `logistic_assign`
--
ALTER TABLE `logistic_assign`
...
--
-- AUTO_INCREMENT de tabela `pay_salary`
--
ALTER TABLE `pay_salary`
...
--
-- AUTO_INCREMENT de tabela `pro_expenses`
--
ALTER TABLE `pro_expenses`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `pro_notes`
--
ALTER TABLE `pro_notes`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `pro_task`
--
ALTER TABLE `pro_task`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `pro_task_assets`
--
ALTER TABLE `pro_task_assets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tbanexo`
--
ALTER TABLE `tbanexo`
  MODIFY `codAnexo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tbcategoriadenunciante`
--
ALTER TABLE `tbcategoriadenunciante`
  MODIFY `codCatDenuncte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tbdadosempresa`
--
ALTER TABLE `tbdadosempresa`
...
--
-- AUTO_INCREMENT de tabela `tbdistrito`
--
ALTER TABLE `tbdistrito`
  MODIFY `codDistrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `tbperfil`
--
ALTER TABLE `tbperfil`
  MODIFY `codPerfil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `tbprovincia`
--
ALTER TABLE `tbprovincia`
  MODIFY `codProvincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de tabela `tbtipodenuncia`
--
ALTER TABLE `tbtipodenuncia`
  MODIFY `codTipoDenuncia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tbutilizador`
--
ALTER TABLE `tbutilizador`
  MODIFY `codUtil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `to-do_list`
--
ALTER TABLE `to-do_list`
  MODIFY `id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `users1`
--
ALTER TABLE `users1`
...
--
-- Limitadores para a tabela `tbanexo`
--
ALTER TABLE `tbanexo`
  ADD CONSTRAINT `tbAnexo_ibfk_1` FOREIGN KEY (`codDenuncia`) REFERENCES `tbdenuncia` (`codDen`);

--
-- Limitadores para a tabela `tbdenuncia`
--
ALTER TABLE `tbdenuncia`
  ADD CONSTRAINT `tbDenuncia_ibfk_1` FOREIGN KEY (`codCatDenuncte`) REFERENCES `tbcategoriadenunciante` (`codCatDenuncte`),
  ADD CONSTRAINT `tbDenuncia_ibfk_2` FOREIGN KEY (`codProvincia`) REFERENCES `tbprovincia` (`codProvincia`),
  ADD CONSTRAINT `tbDenuncia_ibfk_3` FOREIGN KEY (`codCatDenuncte`) REFERENCES `tbcategoriadenunciante` (`codCatDenuncte`),
  ADD CONSTRAINT `tbDenuncia_ibfk_4` FOREIGN KEY (`codTipoDenuncia`) REFERENCES `tbtipodenuncia` (`codTipoDenuncia`),
  ADD CONSTRAINT `tbDenuncia_ibfk_5` FOREIGN KEY (`codUtil`) REFERENCES `tbutilizador` (`codUtil`),
  ADD CONSTRAINT `tbDenuncia_ibfk_6` FOREIGN KEY (`codAnexo`) REFERENCES `tbanexo` (`codAnexo`);

--
-- Limitadores para a tabela `tbdistrito`
--
ALTER TABLE `tbdistrito`
  ADD CONSTRAINT `tbdistrito_ibfk_1` FOREIGN KEY (`codProvincia`) REFERENCES `tbprovincia` (`codProvincia`);

--
-- Limitadores para a tabela `tbutilizador`
--
ALTER TABLE `tbutilizador`
  ADD CONSTRAINT `tbUtilizador_ibfk_2` FOREIGN KEY (`codProvincia`) REFERENCES `tbprovincia` (`codProvincia`);

--
-- Limitadores para a tabela `users1`
--
ALTER TABLE `users1`
